...
extern const char *gm_drum_names[(GM_NOTE_MAXIMUM-GM_NOTE_MINIMUM)+1];
...
// 				// mode 0B
#define TRIGGER_KICK        0	// A GATE 1 - D1
#define TRIGGER_SIDESTICK   1	// A GATE 2 - D2
#define TRIGGER_CLAP        2	// A GATE 3 - D3
#define TRIGGER_SNARE       3	// A GATE 4 - D4
#define TRIGGER_CRASH_1     4	// A GATE 5 - D5	(D6 is clock)
#define TRIGGER_TAMB        5	// A GATE 6 - B1
#define TRIGGER_HITOM       6	// A GATE 7 - B2
#define TRIGGER_LOTOM       7   // A GATE 8 - B3
#define TRIGGER_PEDALHAT    8   // A GATE 9 - B4
#define TRIGGER_OPENHAT     9   // A GATE10 - B5
#define TRIGGER_CLOSEDHAT   10  // A GATE11 - B6
#define TRIGGER_CRASH_2     11  //	      C2
#define TRIGGER_SPLASH      12  //	      C3
#define TRIGGER_VIBRA       13  //	      C4
#define TRIGGER_RIDE_BELL   14	//	      C5
#define TRIGGER_RIDE_CYM    15  //	      C6
